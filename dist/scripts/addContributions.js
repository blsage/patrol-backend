...
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Fetch all users
        const usersResult = yield db_1.default.query('SELECT id, neighborhood_id FROM users');
        ...
        for (const user of users) {
            ...
            for (let i = 0; i < contributionsCount; i++) {
                ...
                // Insert contribution
                yield db_1.default.query(`INSERT INTO contributions (user_id, neighborhood_id, amount, is_monthly, created_at, updated_at, like_count)
